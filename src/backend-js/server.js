...
function getDefaultContent(key) {
  const defaults = {
    ...
    about_structure: { departments: [
      { name: '院管理层', desc: '研究院决策与管理核心', sub: ['专职院长：王俊峰（全面统筹研究院运营、行政、对外合作、整体发展规划）', '兼职院长：蒋惠岭（统筹学术研究、课题规划、专家智库建设、商事调解理论研究）', '学术委员会：沈家本研究学者、高校法学教授、退休司法实务专家、资深律师、沈家本后裔'] },
    ...
    about_history: { items: [
      ...
      { year: '2021年4月', event: '沈家本历史文化园正式开园，同步举办「吴兴论坛——中国法治发展战略」活动，园内设法治文化展厅、研学教室、枕碧楼文献展等主题空间。' },
      { year: '2022年6月', event: '《沈家本手稿五种》由杭州华宝斋书社影印出版（五册一函），湖州市沈家本研究院发行，为中国法学界首度披露沈家本部分未刊手稿。' },
      ...
      { year: '2024年', event: '研究院挂牌设立商事调解研究中心，启动商事调解理论研究与诉前委派调解工作。' },
      { year: '2024年', event: '与中国政法大学法律学院达成深度共建，落地校外教学实践基地，常态化开展师生现场研学与联合课题攻关。' },
      { year: '2025年', event: '聘任同济大学法学院院长蒋惠岭担任兼职院长，强化校地协同与学术引领。' },
      { year: '2025年', event: '正式组建商事调解研究中心调解员队伍，面向买卖合同、知识产权、电商经营等领域提供专业调解服务。' },
      { year: '2026年3月', event: '湖州市司法局与同济大学法学院签署法治文化校地合作协议，在沈家本研究院设立联合研究基地。' },
      { year: '2026年4月', event: '同济大学法学院师生赴沈家本历史文化园开展「寻沈家本故里·访大余村两山」沉浸式研学活动。' },
      { year: '2026年6月', event: '第八届WELEGAL六一五法务节在沈家本历史文化园举行，300余名企业法总、学者、实务专家参会，首创「法治文化地标行」新范式。' },
      { year: '2026年', event: '官网全新上线，集成律师处罚查询、立法追踪、案件评析、政策汇总、招聘聚合五大法律数据模块。' },
    ]},
    about_team: { members: [
