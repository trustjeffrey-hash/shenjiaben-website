...
function getDefaultContent(key) {
  const defaults = {
      ...
      series: [
        ...
        },
        {
          ...
          centers: [
            ...
            { name: '产业发展研究中心', expertName: '姚剑', expertTitle: '高级经济师', expertAvatar: 'assets/images/expert-yaojian.png', centerIntro: '聚焦产业政策法治保障、企业合规治理、投资并购与产业运营等领域，为企业转型升级和产业高质量发展提供法治与商业双重智力支撑。', expertBio: '具备经济学与法学交叉学科背景，曾任职多家大型企业高级管理岗位及 CEO，深耕产业投资、企业战略与商业运营，擅长从商业视角为企业提供合规与增长并重的解决方案。', isVacant: false }
          ]
        },
        {
          name: '（四）行政合规与多元解纷系列',
    ...
    shenjiaben_timeline: { items: [
      { year: '1840年（道光二十年）', event: '出生于浙江湖州府归安县（今浙江吴兴），字子惇，号寄簃。父沈丙莹，官至刑部郎中。' },
      { year: '1845年（道光二十五年）', event: '五岁，随父沈丙莹赴京。' },
      { year: '1857年（咸丰七年）', event: '十七岁，随父在京读书。' },
      { year: '1859年（咸丰九年）', event: '十九岁，著《周官书名考古偶纂》，为生平首部学术著作。' },
      { year: '1860年（咸丰十年）', event: '二十岁，因英法联军火烧圆明园，避难西山。' },
      { year: '1861年（咸丰十一年）', event: '二十一岁，赴贵州铜仁父任所。' },
      { year: '1862年（同治元年）', event: '二十二岁，留居长沙，广泛读书。' },
      { year: '1864年（同治三年）', event: '二十四岁，父去官，援例入京任刑部郎中，由此开始系统学习法律，奠定一生法学根基。' },
      { year: '1865年（同治四年）', event: '二十五岁，返浙参加乡试，考中举人（第六十二名）。' },
      { year: '1866年（同治五年）', event: '二十六岁，首次参加会试，未中。' },
      { year: '1868年（同治七年）', event: '二十八岁，再试不第；刑部学习期满奏留。' },
      { year: '1870年（同治九年）', event: '三十岁，父沈丙莹卒，回乡守丧。' },
      { year: '1879年（光绪五年）', event: '三十九岁，作《四十初度率赋五章》，感慨功名未成；得尚书潘祖荫赏识。' },
      { year: '1883年（光绪九年）', event: '四十三岁，考取进士（二甲第一百名）；补奉天司主稿兼秋审处坐办；专心法律之学。' },
      { year: '1886年（光绪十二年）', event: '四十六岁，第一部法学著作《刺字集》成书刊行，对清代刺字刑制进行系统考证与批判。' },
      { year: '1893年（光绪十九年）', event: '五十三岁，京察上等，外放天津知府。' },
      { year: '1894年（光绪二十年）', event: '五十四岁，经历甲午战争，记日记、赋诗。' },
      { year: '1897年（光绪二十三年）', event: '五十七岁，调任保定知府。' },
      { year: '1898年（光绪二十四年）', event: '五十八岁，处理保定"北关教案"，驳回法国教士无理要求，维护国家主权；戊戌政变。' },
      { year: '1900年（光绪二十六年）', event: '六十岁，八国联军侵华；因曾驳回法国教士无理要求，被联军囚禁近四个月。' },
      { year: '1901年（光绪二十七年）', event: '六十一岁，任刑部右侍郎，开启一生最辉煌的修律时期。' },
      { year: '1902年（光绪二十八年）', event: '六十二岁，受命为修订法律大臣，与伍廷芳主持修律，以收回领事裁判权为目标，拉开中国法律近代化序幕。' },
      { year: '1905年（光绪三十一年）', event: '六十五岁，与伍廷芳联名上《删除律例内重法折》，奏请废除凌迟、枭首、戮尸等酷刑，获准；奏设法律学堂。' },
      { year: '1906年（光绪三十二年）', event: '六十六岁，任大理院正卿（首任院长）；京师法律学堂正式开学（兼管理大臣），开启中国近代法学教育先河。' },
      { year: '1907年（光绪三十三年）', event: '六十七岁，调任法部右侍郎，重组修订法律馆；礼法之争起。' },
      { year: '1910年（宣统二年）', event: '七十岁，任资政院副总裁；《大清现行刑律》正式颁行；礼法之争激化。' },
      { year: '1911年（宣统三年）', event: '七十一岁，辞修订法律大臣职，回法部左侍郎本任。' },
      { year: '1912年（民国元年）', event: '七十二岁，任袁世凯内阁司法大臣；后退隐北京，专心著述，完成晚年代表作《汉律摭遗》。' },
      { year: '1913年（民国二年）', event: '七十三岁，6月9日在北京寓所逝世。墓志铭称"公之学，由经入史，以律为归；公之志，融通中西，折衷至当"。' },
    ]},
    about_team: { members: [
